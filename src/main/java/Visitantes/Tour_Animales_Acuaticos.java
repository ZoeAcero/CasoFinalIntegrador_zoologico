...
public class Tour_Animales_Acuaticos extends Visitantes implements TourGuiado{
        ...
        // Constructor
        public Tour_Animales_Acuaticos(String Edad, String InteresVisitante, String fechaVisita, String horaVisita) {
        ...
        public void realizarTour() {
            System.out.println(("¡Bienvenidos! Vamos a explorar el área de animales acuáticos y aprender sobre ellos."));
        }
}
